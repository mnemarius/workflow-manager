...
- Each view is scoped to the current milestone ([BUSINESS.md](../BUSINESS.md), M1: single-task submit + execute). Multi-step DAGs, retries/leases-in-anger, and horizontal scaling arrive in later milestones and should be added here when they land.
