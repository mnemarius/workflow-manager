 ...
 *
 * <p>Handlers should honor thread interruption: the runtime interrupts the handler thread when
 * the engine revokes the task's lease, and a handler that ignores it keeps burning work another
 * worker now owns.
 */
@FunctionalInterface
